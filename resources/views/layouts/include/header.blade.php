...
<head>
  ...
  <!-- Bootstrap 3.3.7 -->
  <link rel="stylesheet" href="{{asset('temadmin/dist/css/bootstrap-theme.css')}}">
  <!-- Bootstrap rtl -->
  <link rel="stylesheet" href="{{asset('temadmin/dist/css/rtl.css')}}">
  <!-- persian Date Picker -->
  <link rel="stylesheet" href="{{asset('temadmin/dist/css/persian-datepicker-0.4.5.min')}}">
  <!-- Font Awesome -->
  <link rel="stylesheet" href="{{asset('temadmin/bower_components/font-awesome/css/font-awesome.min.css')}}">
  <!-- Ionicons -->
  <link rel="stylesheet" href="{{asset('temadmin/bower_components/Ionicons/css/ionicons.min.css')}}">
  <!-- Theme style -->
  <link rel="stylesheet" href="{{asset('temadmin/dist/css/AdminLTE.css')}}">
  <!-- AdminLTE Skins. Choose a skin from the css/skins
       folder instead of downloading all of them to reduce the load. -->
  <link rel="stylesheet" href="{{asset('temadmin/dist/css/skins/_all-skins.min.css')}}">
  <!-- Morris chart -->
  <link rel="stylesheet" href="{{asset('temadmin/bower_components/morris.js/morris.css')}}">
  <!-- jvectormap -->
  <link rel="stylesheet" href="{{asset('temadmin/bower_components/jvectormap/jquery-jvectormap.css')}}">
  <!-- Daterange picker -->
  <link rel="stylesheet" href="{{asset('temadmin/bower_components/bootstrap-daterangepicker/daterangepicker.css')}}">
  <!-- bootstrap wysihtml5 - text editor -->
  <link rel="stylesheet" href="{{asset('temadmin/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.min.css')}}">
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
              ...
              <li>
                ...
                <ul class="menu">
                  <li><!-- start message -->
                    <a href="#">
                      <div class="pull-right">
                        <img src="{{asset('temadmin/dist/img/user2-160x160.jpg')}}" class="img-circle" alt="User Image">
                      </div>
                      <h4>
                        علیرضا
                  ...
                  <li>
                    <a href="#">
                      <div class="pull-right">
                        <img src="{{asset('temadmin/dist/img/user3-128x128.jpg')}}" class="img-circle" alt="User Image">
                      </div>
                      <h4>
                        نگین
                  ...
                  <li>
                    <a href="#">
                      <div class="pull-right">
                        <img src="{{asset('temadmin/dist/img/user4-128x128.jpg')}}" class="img-circle" alt="User Image">
                      </div>
                      <h4>
                        نسترن
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="{{asset('temadmin/dist/img/user2-160x160.jpg')}}" class="user-image" alt="User Image">
              <span class="hidden-xs">سمانه گل پروری</span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
