    ...
    <div class="banner_inner d-flex align-items-center">
        <div class="container">
            <div class="banner_content row">
                <div class="offset-lg-2 col-lg-8"style="margin-right:150px">
                    {{-- ================================== --}}
                    
                    {{-- <h3>بشتابید
                        <br />زمستان در راه است</h3> --}}
                    {{-- <p>فروشگاه ما بهترین محصولات زمستانی را در اختیار شما قرار میدهد،بهترین کیفت،زیباترین پوشاک و بهترین
                        خرید اینترنتی را با ما تجربه کنید
                    </p> --}}
